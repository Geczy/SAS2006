...
public class Config
{
	...
	public static final String SERVER_NAME = "SAS - Pre Alpha 0.03";
	public static final String WELCOME_MESSAGE = "Welcome to SAS 2006/2005 Remake :D Pre Alpha 0.03";
	...
	public static final int SKILLING_XP = 1;
}
