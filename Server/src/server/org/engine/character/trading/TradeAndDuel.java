...
public class TradeAndDuel
{
	...
	public void openTrade()
	{
		...
		c.getPA().sendFrame126(
				"Trading with: " + Misc.capitalize( o.playerName ) + " who has @gre@" + o.getItems().freeSlots()
						+ " free slots", 3417 );
						...
						if( item.id == itemID ) {
							if( ! item.stackable ) {
								...
								if( item.amount > amount ) {
									...
									o.getPA().sendFrame126( "Trading with: " + Misc.capitalize( c.playerName ) + "",
											3417 );
								} else {
									amount = item.amount;
									offeredItems.remove( item );
	...
	public void openDuel()
	{
		...
		c.getPA().sendFrame126( "Dueling with: " + Misc.capitalize( o.playerName ) + " (level-" + o.combatLevel + ")",
				6671 );
