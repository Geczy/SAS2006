...
public class FletchingHandler
{
	...
	public enum ShortBow {
		...
		private final int logType, req, exp, bowUnStr, bowStr;
	...
	public enum LongBow {
		...
		private final int logType, req, exp, bowU, bow;
	...
	public enum CrossBow {
		...
		private final int logType, req, exp1, exp2, stock, limbs, bowU, bow;
	...
	public enum Arrows {
		...
		private final int req, exp, tips, arrow;
	...
	public enum Bolts {
		...
		private final int input, output, req, exp;
