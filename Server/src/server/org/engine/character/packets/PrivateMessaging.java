								...
								if( PlayerHandler.players[i2] != null
									...
									if( o != null ) {
										if( PlayerHandler.players[i2].privateChat == 0
												|| PlayerHandler.players[i2].privateChat == 1 && o.getPA()
					...
					if( friend == sendMessageToFriendId ) {
						...
						for( int i2 = 1; i2 < Config.MAX_PLAYERS; i2 ++ ) {
							if( PlayerHandler.players[i2] != null
								...
								if( o != null ) {
									if( PlayerHandler.players[i2].privateChat == 0
											|| PlayerHandler.players[i2].privateChat == 1 && o.getPA().isInPM(
													Misc.playerNameToInt64( c.playerName ) ) ) {
										o.getPA().sendPM( Misc.playerNameToInt64( c.playerName ), c.playerRights,
