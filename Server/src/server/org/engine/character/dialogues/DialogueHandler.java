...
public class DialogueHandler
{
	...
	public void sendDialogues( int dialogue, int npcId )
	{
		...
		switch( dialogue ) {
			...
			case 300:
				sendNpcChat1( "Hello there, How may I help?", 741, "Duke Horacio" );
				c.nextChat = 301;
				break;
			case 301:
				c.dialogueAction = 301;
				sendOption3( "About the lottery", "Can i enter the lottery", "Nothing" );
				break;
			case 304:
				sendPlayerChat1( "Can i enter the lottery?" );
				c.nextChat = 305;
				break;
			case 305:
				sendNpcChat3( "Yes you can enter, But", "It cost's 2000 Coins to enter.",
						"Have you got 2000 Coins?", 741, "Duke Horacio" );
				c.nextChat = 306;
				break;
			case 306:
				c.dialogueAction = 306;
				sendOption2( "Yes i have 2000 Coins.", "No i dont have 2000 Coins." );
				break;
			case 307:
				sendNpcChat1( "I Have Entered you in the lottery.", 741, "Duke Horacio" );
				c.nextChat = 0;
				break;
			case 308:
				sendStatement( "You do not have Enought Coins." );
				c.nextChat = 0;
				break;
			case 302:
				sendPlayerChat1( "I want to learn about the lottery." );
				c.nextChat = 303;
				break;
			case 303:
				sendNpcChat4( "Basically When you enter you will be put ", "on a list, and every i think",
						"10 minutes it picks a random player", "And gives the jackpot money.", 741, "Duke Horacio" );
				c.nextChat = 301;
				break;
			/**
			 * End of enter tut basically
			 */
			case 129:
				sendOption5( "Beginner (250x Runescape)", "Jorneyman (100x Runescape)", "Expert (40x Runescape)",
						"Master (10x Runescape)", "Insane (2x Runescape)" );
				c.dialogueAction = 28;
				c.dialogueId = 38;
				break;
			case 0:
			...
			case 6:
				sendNpcChat4( "The way the game works is as follows...", "You will be teleported to the wilderness,",
						"You must kill mages to recieve points,", "redeem points with the chamber guardian.",
			...
			case 502:
				...
				break;
			case 503:
				sendNpcChat3( "I want you to get me", "6 clay, 4 copper ore, and 2 iron ore.", "You up for it?",
						c.talkingNpc, "Doric" );
				c.nextChat = 504;
				break;
			case 504:
			...
			case 507:
				...
				break;
			case 508:
				if( c.getItems().playerHasItem( 434, 1 ) && c.getItems().playerHasItem( 436, 1 )
			...
			case 2000:
				sendNpcChat1( "Sorry cant talk the now.", c.talkingNpc, "" );
				c.nextChat = 2001;
				break;
			case 2001:
			...
			case 50:
				if( c.dragonSlayer == 6 ) {
					sendNpcChat3( "Ohh God !!!", "You killed the dragon !!!", "Have your reward", c.talkingNpc,
							"Oziach" );
					c.nextChat = 87;
				} else {
					sendNpcChat1( "Hello " + Misc.capitalize( c.playerName ) + ", What do you want...", c.talkingNpc,
							"Oziach" );
					c.nextChat = 51;
				}
				break;
			...
			case 73:
				sendNpcChat3( "Now you have to go to Klarence", "In Port Sarim and ask her",
						"If she has any boats for sale.", c.talkingNpc, "Guildmaster" );
				c.nextChat = 0;
				break;
			case 61:// guild
			...
			case 65:
				if( c.dragonSlayer >= 2 ) {
					...
					sendNpcChat2( "If you want to kill the dragon", "You need to know a few thing's.", c.talkingNpc,
							"Guildmaster" );
					c.nextChat = 66;
					c.dragonSlayer = 2;
				}
				break;
			case 66:
				sendNpcChat4( "This dragon is Hard to kill.", "Its breath can kill human in 1 blow",
						"To prevent this from happening you need", "a Anti-Dragon shield and have food.", c.talkingNpc,
						"Guildmaster" );
				c.nextChat = 67;
				break;
			case 67:
				sendNpcChat4( "You also need 3 map peice's", "1 from defeting Melzar the Mad", "1 from Oracle",
						"and the last peice from Wormbrain", c.talkingNpc, "Guildmaster" );
				c.nextChat = 68;
				break;
			case 68:
				if( c.getItems().playerHasItem( 1535 ) &&
					...
					sendOption5( "Where can i get an anti-dragon shield.", "Where can i find Melzar the Mad.",
							"Where can i find Oracle", "Where can i find Wormbrain", "Nothing" );
					c.dialogueAction = 68;
				}
				break;
			case 69:
				sendNpcChat3( "You can get a Anti-dragon Shield ", "From Duke Horacio",
						"In lumbridge castle second floor", c.talkingNpc, "Guildmaster" );
				c.nextChat = 68;
				break;
			case 70:
				sendNpcChat4( "I can find Melzar the mad", "Inside Melzar's Maze which ",
						"is south of the Crafting Guild", "Bring some food and armour.", c.talkingNpc, "Guildmaster" );
				c.nextChat = 68;
				break;
			case 71:
				sendNpcChat3( "I can find Oracle", "At the ice mountains which is",
						"west of Edgeville and north of Falador", c.talkingNpc, "Guildmaster" );
				c.nextChat = 68;
				break;
			case 72:
				sendNpcChat3( "I can find Wormbrain", "In Port Sarim jail", "He wont come easy thought", c.talkingNpc,
						"Guildmaster" );
				c.nextChat = 68;
				break;

			case 74:
				sendNpcChat1( "Hello " + Misc.capitalize( c.playerName ) + ",What are you after?", c.talkingNpc,
						"Klarence" );
				c.nextChat = 75;
				break;
			case 75:
			...
			case 77:
				if( c.dragonSlayer >= 5 ) {
					...
					sendNpcChat3( "Indead i do. i have this", "Beauty right beside me going", "for, lets say 10k?",
							c.talkingNpc, "Klarence" );
					c.nextChat = 78;
				}
				break;
			case 78:
			...
			case 604:
				sendNpcChat4( "I've forgotten to buy the ingredients. I'll never get",
						...
						"four children and a goat to look after. Would you help", "me? Please?", c.talkingNpc, "Cook" );
				c.nextChat = 605;
				break;
			case 605:
			...
			case 611:
				sendNpcChat3( "You can find flour in any of the shops here.", "You can find eggs by killing chickens.",
						"You can find milk by using a bucket on a cow", c.talkingNpc, "Cook" );
				c.nextChat = 0;
				break;
			case 612:
			...
			case 615:
				...
				break;
			case 616:
				if( c.getItems().playerHasItem( 1944, 1 ) && c.getItems().playerHasItem( 1927, 1 )
			...
			case 619:
				...
				break;
			case 620:
				sendNpcChat2( "I'm agraid not, only the big cheeses get to dine with the", "Duke.", c.talkingNpc,
						"Cook" );
				c.nextChat = 621;
				break;
			case 621:
