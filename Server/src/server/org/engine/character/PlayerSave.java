...
public class PlayerSave
{
				...
				switch( ReadMode ) {
					...
					case 2:
						if( token.equals( "character-height" ) ) {
							...
							p.mode = Integer.parseInt( token2 );
	...
	public static boolean saveGame( Client p )
	{
		...
		try {
			...
			characterfile.write( Integer.toString( Player.heightLevel ), 0, Integer.toString( Player.heightLevel )
					.length() );
			characterfile.newLine();
			...
			characterfile.newLine();
			characterfile.write( "Mode = ", 0, 7 );
			characterfile.write( Integer.toString( p.mode ), 0, Integer.toString( p.mode ).length() );
			characterfile.newLine();
			...
			characterfile.write( Integer.toString( p.playerMagicBook ), 0, Integer.toString( p.playerMagicBook )
					.length() );
			characterfile.newLine();
			...
			characterfile.write( Integer.toString( p.barrowsKillCount ), 0, Integer.toString( p.barrowsKillCount )
					.length() );
			characterfile.newLine();
			...
			characterfile
					.write( Boolean.toString( p.accountFlagged ), 0, Boolean.toString( p.accountFlagged ).length() );
			characterfile.newLine();
			...
			for( int i = 0; i < p.playerLevel.length; i ++ ) {
				...
				characterfile.write( Integer.toString( i ), 0, Integer.toString( i ).length() );
				characterfile.write( "	", 0, 1 );
				characterfile.write( Integer.toString( p.playerLevel[i] ), 0, Integer.toString( p.playerLevel[i] )
						.length() );
				characterfile.write( "	", 0, 1 );
			...
			for( int i = 0; i < p.playerItems.length; i ++ ) {
				if( p.playerItems[i] > 0 ) {
					...
					characterfile.write( Integer.toString( i ), 0, Integer.toString( i ).length() );
					characterfile.write( "	", 0, 1 );
					characterfile.write( Integer.toString( p.playerItems[i] ), 0, Integer.toString( p.playerItems[i] )
							.length() );
					characterfile.write( "	", 0, 1 );
					characterfile.write( Integer.toString( p.playerItemsN[i] ), 0, Integer.toString( p.playerItemsN[i] )
							.length() );
					characterfile.newLine();
				}
			}
			...
			for( int i = 0; i < p.bankItems.length; i ++ ) {
				if( p.bankItems[i] > 0 ) {
					...
					characterfile.write( Integer.toString( i ), 0, Integer.toString( i ).length() );
					characterfile.write( "	", 0, 1 );
					characterfile.write( Integer.toString( p.bankItems[i] ), 0, Integer.toString( p.bankItems[i] )
							.length() );
					characterfile.write( "	", 0, 1 );
					characterfile.write( Integer.toString( p.bankItemsN[i] ), 0, Integer.toString( p.bankItemsN[i] )
							.length() );
					characterfile.newLine();
				}
			}
