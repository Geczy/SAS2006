...
public class ObjectManager
{
	...
	public static void appendStateChange( int objectType, int objectX, int objectY, int objectHeight, int objectFace,
			int objectChangeState, int objectVType )
	{
		stateChanges.add( new StateObject( objectType, objectX, objectY, objectFace, objectHeight, objectChangeState,
				objectVType ) );
	}
	...
	public static void removeVarObject( int objectType, int objectX, int objectY, int objectHeight )
	{
		for( int index = 0; index < varObjects.size(); index ++ )
		{
			...
			if( vo.getType() == objectType && vo.getX() == objectX && vo.getY() == objectY
	...
	public static boolean withinRange( int objectType, int objectX, int objectY, int playerX, int playerY, int atHeight )
	{
		...
		java.awt.Rectangle playerField = new java.awt.Rectangle( objectX - 1, objectY - 1, sizeX + 2,
				sizeY + 2 );
		return playerField.contains( playerX, playerY ) && ! objectField.contains( playerX, playerY );
	}


	public static boolean withinDoorRange( int objectType, int objectX, int objectY, int playerX, int playerY,
			int atHeight )
	{
		if( objectSizes.size() == 0 ) {
			loadObjectSizes();
