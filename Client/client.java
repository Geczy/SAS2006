...
public class client extends RSApplet {
	...
	public final String getRank(final int i) {
        switch (i) {
        case 1: return "Beginner";
        case 2: return "Jorneyman";
...
//	notifyItemSpawn(item, i + baseX, j + baseY);
	...
	void drawLoadingText(int i, String s)
	{
		...
		char c1 = '\310';
		byte byte1 = 20;
		chatTextDrawingArea.drawText(0xffffff, "SAS is loading - please wait...", c1 / 2 - 26 - byte1, c / 2);
		int j = c1 / 2 - 18 - byte1;
  ...
  */
	...
	private void login(String s, String s1, boolean flag)
	{
		...
		try
		{
			...
			if(k == 6)
			{
				loginMessage1 = "SAS has been updated!";
...
//	entityMessage(npc);
 ...
 //		   return;
		...
		if(signlink.cache_dat != null)
		{
			...
			multiIcon = new Sprite(streamLoader_2, "Overlay_multiway", 0);	
	...
	private void showErrorScreen()
	{
		...
		if(loadingError)
		{
			...
			int k = 35;
			g.drawString("Sorry, an error has occured whilst loading SAS", 30, k);
			k += 50;
		...
		if(genericLoadingError)
		{
			...
			g.drawString("To play SAS make sure you play from", 50, 100);
			g.drawString("http://www.s.co.cc", 50, 150);
		}
		if(rsAlreadyLoaded)
		{
			aBoolean831 = false;
			g.setColor(Color.yellow);
			int l = 35;
			g.drawString("Error a copy of SAS already appears to be loaded", 30, l);
			l += 50;
			g.setColor(Color.white);
					...
					try
					{
						...
						player.textCycle = 150;
						 if(j2 == 2 || j2 == 3)
							 ...
							 pushMessage(s, 1, getRank(player.skill) + player.name);
					}
					catch(Exception exception)
					{
 ...
 //			   return new DataInputStream((new URL(getCodeBase(), s)).openStream());
	...
	private void drawLoginScreen(boolean flag)
	{
		...
		if(loginScreenState == 0)
		{
			...
			i = c1 / 2 - 20;
			chatTextDrawingArea.method382(0xffff00, c / 2, "Welcome to SAS", i, true);
			i += 30;
			int l = c / 2 - 80;
			int k1 = c1 / 2 + 20;
		...
		{
						chatTextDrawingArea.method382(0xffff00, c / 2, "Create a new account", c1 / 2 - 60, true);
			int k = c1 / 2 - 35;
			chatTextDrawingArea.method382(0xffffff, c / 2, "To create a new account, simply", k, true);
			k += 15;
			chatTextDrawingArea.method382(0xffffff, c / 2, "click 'Existing User' in the previous", k, true);
			k += 15;
			chatTextDrawingArea.method382(0xffffff, c / 2, "screen. Choose your name and pass and login.", k, true);
			k += 15;
			chatTextDrawingArea.method382(0xffffff, c / 2, "Your account gets automatically created.", k, true);
			k += 15;
			int j1 = c / 2;
			int i2 = c1 / 2 + 50;
