    ...
    implements Runnable
{
	...
	{
		boolean exists = (new File(System.getProperty("user.home") + "/sascache/")).exists();
		if (exists) {
			//System.out.println("Directory exists");
			return System.getProperty("user.home") + "/sascache/";
		} else {
			File f = new File(System.getProperty("user.home") + "/sascache/");
			f.mkdir();
